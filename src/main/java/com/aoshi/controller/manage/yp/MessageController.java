...
public class MessageController extends BaseController {
	...
	public String addMessagePage(ModelMap map) {
		return PAGE_PATH + "save";
	}
	...
	public String saveMessage(@RequestParam(value = "files", required = true) MultipartFile[] files, String descp, String title){
		messageService.saveMessage(files, descp, title);
	...
	public String downFile(String itemId)throws Exception{
		 messageService.downFile(itemId);
		return PAGE_PATH + "result";
	}
	/**
	 * 附件下载
	 *
	 */
	@RequestMapping(value = "operDeleFile")
	@ResponseBody
	public int operDeleFile(Integer itemId)throws Exception{
		return messageService.operDeleFile(itemId);
	}
}
