...
public class Const {
	...
	public static final String MANAGERNAME = "admin/config/MANAGERNAME.txt"; // 管理系统名称路径
	...
	public static final String TEMPLATEPATHIMG = "ascmMall/template"; // 模版图片上传路径
	...
	public static final String EVENTFILEPATHIMG = "ascmMall/event"; // 商户活动图片上传路径
	public static final String ACTIVITYFILEPATHIMG = "ascmMall/activity"; // 活动图片上传路径
	public static final String FILEPATHTWODIMENSIONCODE = "uploadFiles/twoDimensionCode/"; // 二维码存放路径
	public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(logout)|(code)|(codeMerchant)|(TenantManage)|(prize)|(app)|(weixin)|(static)|(main)|(websocket)|(notify)).*"; // 不对匹配该值的访问路径拦截（正则）
	public static final String NO_LOG_PATH = ".*/((plugins)|(tab)|(head)).*"; // 不对匹配该值的访问路径记录日志（正则）
	public static final String SHOPQRCODEFILEPATHIMG = "ascmMall/shop/qrCodeUrl"; // 商场二维码图片上传路径
	public static final String SHOPMAINPICFILEPATHIMG = "ascmMall/shop/attachmentUrl"; // 商场背景主图图片上传路径

	public static ApplicationContext WEB_APP_CONTEXT = null; // 该值会在web容器启动时由WebAppContextListener初始化

	public static final String SALT = "aoshi";
	public static final String SHOPMESSAGEMAINPICFILEPATHIMG = "ascmMall/shop/mainPicUrl"; // 消息附件上传路径
	/**
	 * APP Constants
	 */
	// app注册接口_请求协议参数)
	...
	//登陆标识
	public static final String BACKLOGIN = "false";
	//后台登陆标识
	public static final String IS_BACK_LOGIN = "false";
	//审核状态
	public static final Integer[] MERCHANT_LOGIN = new Integer[] { -1, 0, 1, 2, 3, 1010};
	//消息返回码
	public static final Integer[] NEWS_FALG = new Integer[] { 1003, 1004, 1005, 1006,1006};
