...
public class SimpleMailSender extends BaseController {
	 ...
	 *            1：文本格式;2：HTML格式
	 */
	public static void sendEmail(String SMTP, String PORT, String EMAIL, String PAW, String toEMAIL, String TITLE, String CONTENT, String TYPE,String pwd) throws Exception {
		...
		mailInfo.setValidate(true);
		mailInfo.setUserName(toEMAIL);
		mailInfo.setPassword(pwd);// 您的邮箱密码
		mailInfo.setFromAddress(toEMAIL);
...
//		mailInfo.setMailServerPort("25");
//		mailInfo.setValidate(true);
//		mailInfo.setUserName("wen185758815@qq.com");
//		mailInfo.setPassword("wen123");// 您的邮箱密码
//		mailInfo.setFromAddress("wen185758815@qq.com");
//		mailInfo.setToAddress("wen185758815@qq.com");
...
//	}
	...
	public static void main(String[] args) throws AddressException, MessagingException {
        ...
        final String username = "wen185758815";
        final String password = "wen123";

        String from ="wen185758815@163.com";
        String to     = "1625043585@qq.com";
        String subject = "测试邮件ADFAFSADFFASDFSDFADFD";
