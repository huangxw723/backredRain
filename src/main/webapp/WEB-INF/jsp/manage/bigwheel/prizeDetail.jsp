		...
		<tr height="45px">
			<td>礼品类型:</td>			
					<c:if test="${'折扣券' eq p.name }">
						<td id="td4">折扣券&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;折扣力度:&nbsp;&nbsp;<input type="text" disabled="disabled"  value="${p.price}" style="width:50px"  />折</td>
					</c:if>
					<c:if test="${'代金券' eq p.name}">
						<td id="td4">代金券&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;优惠额度:&nbsp;&nbsp;<input type="text" disabled="disabled"   value="${p.price}" style="width:50px" />元</td>
					</c:if>
