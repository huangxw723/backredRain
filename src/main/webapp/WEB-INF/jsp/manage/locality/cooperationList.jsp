...
<div class="container-fluid" id="main-container">
    <div id="page-content" class="clearfix">
        <div class="row-fluid">
            <div class="row-fluid">
                <!-- 检索  -->
                <form action="business/addCooperation.do" method="post" name="Form" id="Form">
                            ...
                            <c:when test="${not empty storeList}">
                                    <c:forEach items="${storeList}" var="var" varStatus="vs">
                                        <tr>
                                            ...
                                            <td class='center' style="text-align:center;">${var.storeId}</td>
                    ...
                    <div class="page-header position-relative">
                        <table style="width: 100%;">
                            <tr>
                                <td style="vertical-align:top;">
                                    <a class="btn btn-small btn-success" onclick="commit('确定要添加选中的数据吗?')">新增</a>
                                </td>
            ...
            if (result) {
                ...
                if (str == '') {
                    ...
                    return;
                        ...
                        $.ajax({
                            type: "POST",
                            url: '<%=basePath%>business/addCooperationIds.do',
