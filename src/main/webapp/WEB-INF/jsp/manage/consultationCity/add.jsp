...
<body>  
    <form action="consultationCity/saveAdd.do" enctype="multipart/form-data" name="form" id="form" method="post">
   ...
   <!-- <input type="hidden" name="latlng"id="latlng" > -->
    ...
    <div id="zhongxin">
      <table id="table_report" class="table table-striped table-bordered table-hover">
        ...
        <tr>
          <th>简介:</th>
          <td><textarea placeholder="请输入简介，最多可输入1000个字" name="consultationDesc" id="consultationDesc" style="width: 750px;resize:none;height:100px;"></textarea></td>
       	</tr>
  ...
  <script type="text/javascript">
	...
	$('#fileInput:visible').ace_file_input({
		no_file : '请选择宽高度为(720*380)dp的图片 ...（图片≤100M）',
		btn_choose : '选择',
		btn_change : '更改',
		droppable : false,
		onchange : null,
	...
	<!-- <script type="text/javascript">
		jQuery(document).ready(function() {
			sear(document.getElementById('address').value);
		});
