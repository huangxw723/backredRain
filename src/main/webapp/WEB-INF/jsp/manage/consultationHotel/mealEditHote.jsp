					...
					<table style="width: 100%;">
						<tr>
							<td style="vertical-align:top;">
								<a class="btn btn-small btn-success" onclick="add(${consultationId},${fn:length(imgs)},${typeId});">新增</a>
...
<script type="text/javascript">
	...
	function add(id,imgs,typeId){
		...
		diag.Drag=true;
		diag.Title ="新增";
		diag.URL = '<%=basePath%>consultationHotel/toAddImg.do?id='+id+"&typeId="+typeId;
		diag.Width = 900;
		diag.Height = 700;
	...
	function edit(id){
		...
		diag.Drag=true;
		diag.Title ="编辑";
		diag.URL = '<%=basePath%>consultationHotel/toEditImg.do?id='+id;
		diag.Width = 900;
		diag.Height = 750;
		diag.CancelEvent = function(){ //关闭事件
			diag.close();
...
//		}
		if(confirm("确定删除吗?")){
			...
			$.ajax({
				type: "POST",
				url: '<%=basePath%>consultationHotel/deleteImg.do',
				data: {id:id},
				dataType:'json',
