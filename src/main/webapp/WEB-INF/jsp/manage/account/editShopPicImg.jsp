...
<body>
	<div id="page-content" class="clearfix">
		...
		<div class="row-fluid">
			...
			<form class="form-horizontal" id="form" action="account/editShopPicImgs.do" method="post" enctype="multipart/form-data">
				<input type="hidden" name="shopId" value="${shopId}">
				<input type="hidden" name="shopPicId" value="${shopPicId}">
				<div class="control-group" >
					<label class="control-label">上传背景图</label>
					<div class="controls" style="width: 300px">
				              ...
				              <font color="red">注：(图片尺寸规格750px * 476px)</font>
