...
<body>
	<form action="consultationInfo/saveAdd.do"
		enctype="multipart/form-data" name="form" id="form" method="post">
		<input type="hidden" name="status" id="status" value=1> <input
			type="hidden" name="latlng" id="latlng">
		<div id="zhongxin">
			<table id="table_report"
				class="table table-striped table-bordered table-hover">
				<tr>
					<th>资讯类型:</th>
					<td><select class="chzn-select" style="vertical-align: top;">
							<option value="37">百科</option>
					</select> <select class="chzn-select" name="typeId" id="typeId"
						data-placeholder="请选择二级分类" style="vertical-align: top;">
							<option value=""></option>
              ...
              <c:forEach items="${areaList}" var="district"> 
				...
				<tr>
					...
					<td><input type="text" style="width: 90%;" name="title"
						id="title" placeholder="这里输入标题" title="标题" /></td>
				</tr>

				<tr>
					<th>封面图:</th>
					<td><a id="imgBox" href="javascript:void(0)"
						style="display: none;"> <img src="" width="750" height="666" id="imgHref" />
					</a> <input type="file" id="fileInput" name="file" /> <input id="url"
						name="img" type="hidden" />
				...
				<tr>
					<th>简介:</th>
					<td><textarea placeholder="请输入简介，最多可输入1000个字"
							name="consultationDesc" id="consultationDesc"
							style="width: 750px; resize: none; height: 100px;"></textarea></td>
				</tr>
