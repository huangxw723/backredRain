...
<div id="page-content" class="clearfix" style="margin-top: 50px">
	...
	<div class="row-fluid">
				...
				<ul>
						<li style="margin-left: 10px" ng-repeat="t in businessTemplates">
							<img alt="" ng-src="static/template/images/{{t.preview}}.png">
								<c:if test="${select == 1}">
									<a href="javascript:void(0);" ng-click="selection(t.businessTemplateId)">选择({{t.templateName}})</a>
								</c:if>
			...
			<div class="page-header position-relative">
				<form action="yp/admin/template/getBusinessSysTemplates.do" method="post" name="" id="">
