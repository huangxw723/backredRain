...
<body>
	<div id="page-content" class="clearfix">
		...
		<div class="row-fluid">
			...
			<form class="form-horizontal" id="form" action="yp/admin/template/addTemplate.do" method="post">

				<div class="control-group">
					<label class="control-label">模版名称</label>
					<div class="controls">
						<input type="text" name="name" placeholder="模版名称" required />
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">模版路径</label>
					<div class="controls">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="preview" placeholder="如:template1.png" required />
					</div>
				</div>
				<div class="control-group">
		...
		$(document).ready(function(){
			...
			$("#save").on("click",function(){
				...
				var type = $("[name=path]").val();
				if(undefined==name || name.trim()==""){
					alert("名称不能为空");
					return ;
				}
				if(undefined==type || type.trim()==""){
					alert("页面名称不能为空");
					return ;
				}
