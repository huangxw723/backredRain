	...
	<div id="page-content" class="clearfix">
		...
		<div class="row-fluid">
			...
			<form class="form-horizontal" id="form" action="yp/admin/template/saveImageSource.do" method="post" enctype="multipart/form-data">
				<input type="hidden" name="imageSourceId" value="${image.imageSourceId}"/>
				<div class="control-group" >
					...
					<div class="controls">
							...
							<div style="float: left;">
								<img id="image1" alt="" src="<%=httpUrl%>${image.imageUrl}" style="max-width:350px;"/>
							</div>
					...
					<div class="controls">
						<select name="templateTypeId">
							...
							<c:forEach items="${templateTypes}" var="type">
								<option ${type.templateTypeId==image.templateTypeId?'selected':'' } value="${type.templateTypeId }">${type.typeName}</option>
							</c:forEach>
						</select>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="imageName" value="${image.imageName}" placeholder="图片名称" />
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input id="width" type="text" value="${image.width}" name="width" readonly />
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input id="height" type="text" value="${image.height}" name="height" readonly />
					</div>
				</div>
