...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
		...
		<form action="<%=basePath%>yp/admin/public/getServiceTypeList" method="post" name="usersForm" id="usersForm" style="display:none;">
					...
					<c:when test="${not empty list}">
						<c:forEach items="${list}" var="var" varStatus="vs">
							...
							<tr>
								...
								<td class='center' style="text-align:center;">${var.counts}</td>
								
								<td class='center' style=" style="text-align:center;">
									<a href="javascript:void(0);" onclick="idelete(${var.categoryId})">删除</a>
								</td>
...
<!--/#page-content-->
		...
		function add(){
			...
			form.find('#showCount').attr('name','showCount');
			 ...
			 diag.Drag=true;
			 diag.Title ="添加行业分类";
			 diag.URL = '<%=basePath%>yp/admin/public/goEditServiceTypePage?action=1';
			 diag.Width = 600;
			 diag.Height = 100;
