		...
		<div id="page-content" class="clearfix">
			...
			<div class="row-fluid">
				...
				<div class="row-fluid">
					...
					<!-- 检索  -->
					<form action="yp/admin/ypScreenDomain/listShopAll.do" method="post"
						...
						<input type="hidden" id="shopId" name="shopId" value="${pd.shopId}" />
						<table>
...
<!-- 									class="btn btn-small btn-success" onclick="add('1');">新增</a></td> -->
											...
											<tr>
												...
												<td style="text-align: center;">
													<a  href="javascript:void(0);"
																onclick="screenView(${var.url},${var.url})">${var.url}</a>
													</td>
												...
												<td style="width: 120px;" class="center">
													<div class="inline position-relative">
														<c:if test="${QX.edit == 1}">
																...
																<a href="javascript:void(0);"
																onclick="screenView(${var.shopId},${var.screenDomainId})">查看屏</a>
																<a href=""
																onclick="toUtl(${var.screenDomainId},2)">编辑</a>
	...
	<script type="text/javascript">
	  ...
	  //查看
	   function screenView(id,screenDomainId){
			console.log("id:"+id+"ace:"+screenDomainId);
			var form = $("#domainForm");
			...
			form.find('#showCount').attr('name','showCount');
			 ...
			 diag.Drag=true;
			 diag.Title ="资料";
			 diag.URL = '<%=basePath%>yp/admin/ypScreenDomain/screenList.do?shopId='+id+'&domainId='+screenDomainId;
			 diag.Width = 700;
			 diag.Height = 600;
		...
		function edit(id,oty){
			...
			form.find('#currentPage').attr('name','currentPage');
			form.find('#showCount').attr('name','showCount');
			$.get("yp/admin/ypScreenDomain/updataDomain",{screenDomainId:id,status:oty},function(data){	
				if(data.status != 0){
					alert(data.msg);
					return;
				}
