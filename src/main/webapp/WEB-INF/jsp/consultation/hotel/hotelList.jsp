    ...
    <div id="page-content" class="clearfix">
        ...
        <div class="row-fluid">
            ...
            <div class="row-fluid">
                ...
                <!-- 查询  -->
                <form action="consultationHotel/hotelList.do" method="post" name="usersForm" id="usersForm">
                    <table>
                        <tr>
                            <td>
							<span>
                                ...
                                <span>
								品牌:
								<select class="chzn-select" name="brandId" id="brandId" style="vertical-align:top;width: 115px">
									<option value="">全部</option>
									<c:forEach items="${brandList}" var="brand">
                                        <option value="${brand.brandId}" <c:if test="${pd.brandId==brand.brandId}">selected</c:if>>${brand.brandName}</option>
                                    </c:forEach>
								</select>
							</span>
                                <span>
								...
								酒店名称:&nbsp;<input autocomplete="off" id="nav-search-input" type="text" name="keyWord" value="${keyWord}" placeholder="请输入关键词搜索" style="width:230px;"/>
                            ...
                            <c:forEach items="${list}" var="var" varStatus="vs">
                                ...
                                <tr>
                                    ...
                                    <td class='center'  style="text-align:center;">
                                        ...
                                        <a href="javascript:void(0);" onclick="del(${var.consultationTrafficId})">删除</a>
                                    </td>
                                </tr>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            <td style="vertical-align:top;">
                                ...
                                <a class="btn btn-small btn-danger" onclick="offSelect('确定要下架选中的数据吗?');"><i class='icon-trash'></i>批量下架</a>
                            </td>
                            <td style="vertical-align: top;">
...
<script type="text/javascript">
    ...
    function edit(id){
        ...
        diag.Drag=true;
        diag.Title ="编辑";
        diag.URL = '<%=basePath%>consultationHotel/toEdit.do?action=2&id='+id;
        diag.Width = 850;
        diag.Height = 700;
        diag.CancelEvent = function(){ //关闭事件
            diag.close();
    ...
    function del(Id){
        bootbox.confirm("确定要删除吗?", function(result) {
            if(result) {
                top.jzts();
                var url = "<%=basePath%>consultationHotel/deleteById.do?id="+Id;
