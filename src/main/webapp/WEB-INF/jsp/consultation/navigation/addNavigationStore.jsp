...
<form action="consultation/navigation/addNavigationStore.do" name="usersForm" id="usersForm" method="post">
	...
	<div id="zhongxin" >
		<table id="table_report" class="table table-striped table-bordered table-hover" style="overflow:scroll;">
			<tr height="45px">
				<td>商场名称:</td>
				<td>
					<input type="text" style="width:370px;" name="name" id="name"  placeholder="这里输入商场名称" title="商场名称" />
				</td>
			</tr>
			...
			<tr height="45px">
				<td>官网链接：</td>
				<td>
					<input  type="text" name="site" id="site"  style="width: 370px" placeholder="这里输入官网链接(没有可不填)" title="官网链接"/>
