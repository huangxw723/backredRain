...
<form action="shopping/imgAdd.do" name="usersForm" id="usersForm" method="post">
	<input type="hidden" name="typeId"  value="${img.typeId}">
	<input type="hidden" name="consultationId"  value="${img.consultationId}">
	<div id="zhongxin" >
		<table id="table_report" class="table table-striped table-bordered table-hover" style="overflow:scroll;">
				...
				<td>
						...
						<span style="color: red; width: 50px; font-size:15px;">注：图片格式支持 :gif/png/jpg/jpeg 尺寸规格:750PX * 320PX</span>								
