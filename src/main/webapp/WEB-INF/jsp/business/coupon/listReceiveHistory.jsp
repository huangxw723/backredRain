...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<form action="coupon/couponsReceiveHistory.do" method="post" name="usersForm" id="usersForm">
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		function ReceivePrize(){
					...
					form.find('#showCount').attr('name','showCount');
					 ...
					 diag.Drag=true;
					 diag.Title ="兑换中心";
					 diag.URL = '<%=basePath%>coupon/toReceive.do';
					 diag.Width = 470;
					 diag.Height = 260;
        ...
        function queryDetail(Id){	
			...
			form.find('#showCount').attr('name','showCount');
			 ...
			 diag.Drag=true;
			 diag.Title ="礼品详情";
			 diag.URL = "<%=basePath%>coupon/toPrizeDetail.do?id="+Id;
			 diag.Width = 750;
			 diag.Height = 630;
			 diag.CancelEvent = function(){ //关闭事件
				diag.close();
