...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="prizeconfig/couponsListHistory.do" method="post" name="usersForm" id="usersForm">
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		function toExcel(){
			...
			window.location.href='<%=basePath%>prizeconfig/couponsExcelHistory.do?provinceId='+provinceId+'&cityId='+cityId+'&areaId='+areaId+'&categoryId='+categoryId+'&couponTagId='+couponTagId+'&status='+status+'&keyWord='+keyWord+'&showCount='+showCount+'&currentPage='+currentPage;
