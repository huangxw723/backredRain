...
<form action="beacon/update.do" name="usersForm" id="usersForm" method="post" enctype="multipart/form-data">
	<input type="hidden" name="beaconUidId" id="beaconUidId" value="${asBeaconUid.beaconUidId}">
	<div id="zhongxin" >
		<table id="table_report" class="table table-striped table-bordered table-hover" style="overflow:scroll;">
			<tr height="45px">
				...
				<td>
					<input type="text" style="width:370px;" name="beaconUidUuid" id="beaconUidUuid" value="${asBeaconUid.beaconUidUuid}"  title="beaconUUID编号" />
				</td>
			</tr>
			<tr height="45px">
