...
<body>
	<form action="link/beacon/readExcel.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
		...
		<table style="width:95%;" >
			...
			<tr>
				<td style="text-align: center;padding-top: 20px;" >
					...
					<a class="btn btn-mini btn-success" onclick="window.location.href='<%=basePath%>/link/beacon/downExcel.do'">下载模版</a>
				</td>
			</tr>
		</table>
		</div>
