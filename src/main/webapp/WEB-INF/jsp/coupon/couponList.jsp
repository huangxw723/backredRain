    ...
    <div id="page-content" class="clearfix">
        ...
        <div class="row-fluid">
            ...
            <div class="row-fluid">
                ...
                <!-- 查询  -->
                <form action="link/activityLink/couponList.do" method="post" name="usersForm" id="usersForm" style="margin: 10px">
                        ...
                        <tr style="vertical-align: top;">
                            ...
                            <span>
								...
								<select class="chzn-select" name="rangeType" id="rangeType" data-placeholder="请选择范围" style="vertical-align:top;width: 115px">
                                  ...
                                  <option value="5" <c:if test="${pd.rangeType == 5}">selected</c:if>>商户</option>
            					</select>
							</span>
                            ...
                            <span class="shop" style="display: none">
                                <span>
								商户:
                                    <select class="chzn-select" name="shop" id="shop" data-placeholder="请选择商户" style="vertical-align:top;width: 115px">
                                      <option value=""></option>
                                      <option value="">全部</option>
                                      <c:forEach items="${shopOwnerInfosList}" var="shopOwnerInfo">
                                          <option value="${shopOwnerInfo.shopId }" <c:if test="${shopOwnerInfo.shopId ==pd.shop}">selected="selected"</c:if>>${shopOwnerInfo.name }</option>
                                      </c:forEach>
                                    </select>
							    </span>
                            </span>
                            ...
                            <c:forEach items="${list}" var="var" varStatus="vs">
                                ...
                                <tr>
                                    ...
                                    <td class='center' style="text-align:center;">
                                        ...
                                        <c:if test="${var.rangeType ==5}">商户</c:if>
                                    </td>
                                    <td class='center' style="text-align:center;">
                                        <c:choose>
                                    ...
                                    <td class='center' style="text-align:center;">
                                        <c:choose>
                                            <c:when test="${empty var.shopName}">
                                                --
                                            </c:when>
                                            <c:otherwise>
                                                ${var.shopName}
...
<script type="text/javascript">
    ...
    function add(){
        ...
        diag.Drag=true;
        diag.Title ="新增";
        diag.URL = '<%=basePath%>link/activityLink/toAddCoupon.do';
        diag.Width = 900;
        diag.Height = 450;
    ...
    function edit(id){
        ...
        diag.Drag=true;
        diag.Title ="编辑";
        diag.URL = '<%=basePath%>link/activityLink/toCouponEdit.do?id='+id;
        diag.Width = 850;
        diag.Height = 700;
        diag.CancelEvent = function(){ //关闭事件
            diag.close();
    ...
    function copyToClipboard(link){
        ...
        var link = $("<div>")
                .append($("<div>").append($("<span>").text("优惠券：").after($("<input type='text'>").css("width","80%").attr("value", zhuanpan)).after(zhuanpanA)));
        bootbox.dialog(link,
                [{
                    "label" : "关闭",
                    "class" : "btn-small btn-success",
