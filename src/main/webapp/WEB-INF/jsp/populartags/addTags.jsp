...
<form action="popularTags/addTags.do" name="usersForm" id="usersForm" method="post" enctype="multipart/form-data">
	<div id="zhongxin" >
		<table id="table_report" class="table table-striped table-bordered table-hover" style="overflow:scroll;">			
			<tr height="45px">
				<td width="100px">标签名称:</td>
				<td>
					<input type="text" style="width:370px;" name="tagsName" id="tagsName"  placeholder="15个字符以内"  />
				</td>
			</tr>		
			<tr height="45px">
				...
				<option value="4" >活力广州</option>
				<option value="5" >逛街go</option>
                </select>
				</td>
			</tr>
			<tr height="45px">
			...
			<tr height="45px">
				...
				<td>
					<input type="text" style="width:370px;" name="sortOrder" id="sortOrder"  placeholder="序号"  />
				</td>
			</tr>
			<tr height="45px">
