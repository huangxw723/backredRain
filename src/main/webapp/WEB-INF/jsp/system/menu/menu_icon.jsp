		...
		<form action="menu/editicon.do" name="menuForm" id="menuForm" method="post">
			...
			<table id="table_report" class="table table-striped table-bordered table-hover">
				...
				<tr>
					...
					<td><label onclick="seticon('icon-user');"><input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl">&nbsp;<i class="icon-user"></i></span></label></td>
				...
				<tr>
					<td><label onclick="seticon('icon-wrench');"><input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl">&nbsp;<i class="icon-wrench"></i></span></label></td>
					...
					<td><label onclick="seticon('icon-home');"><input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl">&nbsp;<i class="icon-home"></i></span></label></td>
					...
					<td><label onclick="seticon('icon-shopping-cart');"><input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl">&nbsp;<i class="icon-shopping-cart"></i></span></label></td>
					<td><label onclick="seticon('icon-gift');"><input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl">&nbsp;<i class="icon-gift"></i></span></label></td>
					<td><label onclick="seticon('icon-legal');"><input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl">&nbsp;<i class="icon-legal"></i></span></label></td>
				</tr>
				<tr>
