...
<form action="link/activityLink/updateLink.do" name="usersForm" id="usersForm" method="post" enctype="multipart/form-data">
	...
	<div id="zhongxin" >
		<table id="table_report" class="table table-striped table-bordered table-hover" style="overflow:scroll;">
					...
					<span class="store" ng-if="rangeType == 2">
						...
						<span>
							<select ng-init="p = initProvince()" ng-model="p" ng-change="selectProvince(p)" name="province" id="province" data-placeholder="请选择省份" style="vertical-align:top;width: 90px">
								...
								<option ng-cloak class="ng-cloak" ng-repeat="province in provinceList track by $index" value="{{province.provinceId }}"  >{{province.provinceName }}</option>
            				</select>
						</span>
			...
			<tr height="45px">
                ...
                <td>
                    <input type="text" style="width:100px;" name="perCount" id="perCount"  placeholder="参与次数" title="每人每天参与次数" value="{{asActivityLink.perCount}}"/>
                </td>
            </tr>
			<tr height="45px">
...
<script type="text/javascript">
	...
	module.controller("myCtrl",function($scope){
		...
		$scope.save = function(){
			...
			$.ajax({
				type: "POST",
				url: 'link/activityLink/updateLink.do',
				data: data,
				dataType: "json",
