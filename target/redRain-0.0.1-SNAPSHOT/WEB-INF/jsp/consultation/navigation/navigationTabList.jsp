        ...
        <ul class="nav nav-tabs" id="myTab">
          <li class="active">
            <a data-toggle="tab" data-target="#district" href="javascrpipt:void(0);">
              <i class="green icon-list-alt bigger-150"></i> 商场导航
            </a>
          </li>
          <li>
            <a data-toggle="tab" data-target="#store" href="javascrpipt:void(0);">
              <i class="red icon-list-alt bigger-150"></i> 店铺导航
            </a>
          </li>
        </ul>
        <div class="tab-content">
          <div id="district" class="tab-pane fade in active">
            <iframe name="districtFrame" id="districtFrame" frameborder="0" src="<%=basePath%>consultation/navigation/storeList.do?type=1" style="margin:0 auto;width:100%;height:100%;"></iframe>
          </div>
          <div id="store" class="tab-pane fade">
            <iframe name="storeFrame" id="storeFrame" frameborder="0" src="<%=basePath%>consultation/navigation/shopList.do?type=0" style="margin:0 auto;width:100%;height:100%;"></iframe>
          </div>
        </div>
      </div>
