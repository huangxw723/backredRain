...
<body>
  <form action="consultation/type/saveType.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
    <%--<input type="hidden" name="consultationTypeId" id="consultationTypeId" value="${goodsType.goodsTypeId }" />--%>
    ...
    <div id="zhongxin">
      <table id="table_report" class="table table-striped table-bordered table-hover">
        <tr>
          <th>分类名称:</th>
          <td>
            <input type="text" style="width:90%;" name="typeName" id="typeName" placeholder="这里输入咨询名称" title="咨询名称" />
          </td>
        </tr>
          <tr>
            <th>选择父节点:</th>
            <td>
              ...
              <input type="text" style="width:90%;" disabled name="parentName" id="parentName" />
        ...
        <tr>
          <th>分类排序:</th>
          <td>
            <input name="sortOrder" id="sortOrder" type="number"  placeholder="请在这里输入咨询排序" title="咨询排序" />
          </td>
        </tr>
        <tr>
