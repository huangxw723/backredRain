...
<body>																				
  <form action="spots/spotsSave.do" name="form" id="form" method="post" enctype="multipart/form-data">
    ...
    <div id="zhongxin">
      <table id="table_report" class="table table-striped table-bordered table-hover">
        ...
        <tr>
          <th>简介:</th>
          <td><textarea style="width: 400px;height: 150px"  name="consultationDesc"  id="desc" placeholder="这里输入简介,最多可输入100个字"></textarea></td>
        </tr>
         <tr>
          <th>开放时间:</th>
          <td><input type="text" name="openTime" id="openTime" placeholder="请输入开放时间，开始时间和结束时间请以英文分号分割" style="width: 400px">
          <span style="color: red; width: 50px;" >例如:周一到周五：9:00-21:00;周六到周日：8:00-22:00 </span></td>
        </tr>
        <tr>
          <th>联系电话:</th>
          <td><input type="text" name="phone" id="phone" placeholder="请输入联系电话" style="width: 400px"></td>
        </tr>
        <tr>
          <th>地铁路线:</th>
      ...
      <tr>
		<td colspan="2"><span style="color: red;font-size:15px; margin-left: 80px;" >注:图片尺寸 宽:750 PX,高:320 PX</span></td>
	 </tr>
