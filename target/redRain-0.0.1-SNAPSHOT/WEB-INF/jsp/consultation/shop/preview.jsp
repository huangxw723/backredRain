	...
	<div id="zhongxin" >
		<table id="table_report" class="table table-striped table-bordered table-hover" style="overflow:scroll;">
			<tr height="45px">
				...
				<td>
					<select disabled="disabled">
						<option value="${asConsultationShop.name}">${asConsultationShop.name}</option>
					</select>
				</td>
			</tr>
			<%--<tr height="45px">--%>
				...
				<%--<td>--%>
					<%--<select disabled="disabled">--%>
						<%--<option value="${shopTypeName}">${shopTypeName}</option>--%>
					<%--</select>--%>
				<%--</td>--%>
			<%--</tr>--%>
			<tr height="45px">
				...
				<td>
					<span>
						省份:
						<select class="chzn-select" name="provinceId" id="provinceId" data-placeholder="请选择省份" style="vertical-align:top;width: 115px" disabled="disabled">
							<option value=""></option>
					...
					<span>
					    城市:
						<select class="chzn-select" name="cityId" id="cityId1" data-placeholder="请选择城市" style="vertical-align:top;width: 115px" disabled="disabled">
							<option value=""></option>
							<c:forEach items="${cityList}" var="city">
								<option value="${city.cityId}" <c:if test="${city.cityId == asConsultationShop.cityId}">selected</c:if>>${city.cityName }</option>
							</c:forEach>
						</select>
					</span>
					<span>
						区域:
						<select class="chzn-select" name="areaId" id="areaId" data-placeholder="请选择县区" style="vertical-align:top;width: 115px" disabled="disabled">
							<option value=""></option>
							<c:forEach items="${areaList}" var="area">
								<option value="${area.areaId }" <c:if test="${area.areaId == asConsultationShop.areaId}">selected</c:if>>${area.areaName }</option>
							</c:forEach>
						</select>
					</span>
					<span>
						商圈:
						<select class="chzn-select" name="businessDistrictId" id="businessDistrictId" data-placeholder="请选择商圈" style="vertical-align:top;width: 115px" disabled="disabled">
							<option value="">${asConsultationShop.districtName}</option>
						</select>
					</span>
				</td>
			</tr>
			<tr height="45px">
				<td>店铺名称:</td>
				<td>
					<input type="text" style="width:370px;" name="shopName" id="shopName" value="${asConsultationShop.shopName}" placeholder="这里输入店铺名称" title="店铺名称" disabled="disabled"/>
				</td>
			</tr>
			...
			<tr height="45px">
				<td>官网网址:</td>
				<td>
					<input type="text" style="width:370px;" name="site" id="site" value="${asConsultationShop.site}" placeholder="这里输入官网网址" title="官网网址" disabled="disabled"/>
				</td>
			</tr>
			...
			<tr height="45px">
				...
				<td>
					<div id="l-map"></div>
					<input type="text" style="width:90%;" name="address" id="address" value="${asConsultationShop.address}"  placeholder="这里输入地址" title="地址" disabled="disabled"/>
			...
			<tr height="45px">
				<td>电话:</td>
				<td>
					<input type="text" style="width:370px;" name="phone" id="phone" value="${asConsultationShop.phone}" placeholder="这里输入电话" title="电话" disabled="disabled"/>
				</td>
			</tr>
			<tr height="45px">
				<td>营业时间:</td>
				<td>
					<input type="text" style="width:370px;" name="businessTime" id="businessTime" value="${asConsultationShop.businessTime}" placeholder="这里输入营业时间" title="营业时间" disabled="disabled"/>
				</td>
			</tr>
			<tr height="45px">
				<td>推荐指数:</td>
				<td>
					<input type="text" style="width:370px;" name="starLevel" id="starLevel" value="${asConsultationShop.starLevel}" placeholder="这里输入推荐指数" title="推荐指数" disabled="disabled"/>
				</td>
			</tr>
			<tr height="45px">
				<td>参考价:</td>
				<td>
					<input type="text" style="width:338px;" name="suggestPrice" id="suggestPrice" value="${asConsultationShop.suggestPrice}" placeholder="这里输入参考价" title="参考价" disabled="disabled"/><span style="font-weight: bold">元/人</span>
				</td>
			</tr>
			<tr>
				<td>封面图:</td>
			...
			<tr>
				...
				<td>
					...
					<c:if test="${asConsultationShop != null && asConsultationShop.bannerImg != '' && asConsultationShop.bannerImg != null }">
						...
						<c:if test="${action !=null && action != '' && action!=4}">
							<input type="button" class="btn btn-mini btn-danger" value="更改" onclick="changeImg2()" id="chImg" />
