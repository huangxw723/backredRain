...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="prizeconfig/shakeListHistory.do" method="post" name="usersForm" id="usersForm">
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		function toExcel(){
			...
			window.location.href='<%=basePath%>prizeconfig/shakeExcelHistory.do?categoryId='+categoryId+'&status='+status+'&isJackpot='+isJackpot+'&keyWord='+keyWord+'&showCount='+showCount+'&currentPage='+currentPage;
