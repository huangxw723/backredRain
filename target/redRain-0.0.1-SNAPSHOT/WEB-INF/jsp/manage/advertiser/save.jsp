...
<body>
	...
	<table id="table_report" class="table table-striped table-bordered table-hover" style="overflow:scroll;">
		<tr height="45px">
			<td>联系人:</td>
			<td><input <c:if test="${action == 4 }">disabled="disabled"</c:if> type="text"  value="${pd.contactName}" style="width: 370px" onkeyup="validateUtils.replaceSpaceEmpty(this);"/></td>
			<td>联系电话:</td>
			<td><input <c:if test="${action == 4 }">disabled="disabled"</c:if>type="text" value="${pd.contactPhone}" style="width: 370px"  /></td>
		</tr>
		<tr height="45px">
			<td>公司名称:</td>
			<td><input <c:if test="${action == 4 }">disabled="disabled"</c:if> type="text"value="${pd.companyName}" style="width: 370px" onkeyup="validateUtils.replaceSpaceEmpty(this);"/></td>
			<td>公司地址:</td>
		...
		<tr height="45px">
			<td>微信昵称:</td>
			<td><input <c:if test="${action == 4 }">disabled="disabled"</c:if> type="text"value="${pd.wecharNickname}" style="width: 370px" onkeyup="validateUtils.replaceSpaceEmpty(this);"/></td>
			<td>来源:</td>
			<td><input <c:if test="${action == 4 }">disabled="disabled"</c:if> type="text"  value="<c:if test="${pd.source ==1}">扫码</c:if>" style="width: 370px"  /></td>
		</tr>
		<tr height="45px">
			<td>提交时间:</td>
			<td><input <c:if test="${action == 4 }">disabled="disabled"</c:if>type="text" value="${pd.createTime}" style="width: 370px" onkeyup="validateUtils.replaceSpaceEmpty(this);"/></td>
			<td>客户要求:</td>
