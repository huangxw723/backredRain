...
<body>
	<div id="page-content" class="clearfix">
		...
		<div class="row-fluid">
			...
			<form class="form-horizontal" id="form" action="yp/admin/template/saveInvestImg.do" method="post" enctype="multipart/form-data">
				...
				<div class="control-group" >
					...
					<div class="controls">
							...
							<!-- <span class="help-inline" style="text-align: center;">
								<a href="javascript:return false" onclick="addImg('inp1')">选择背景图片</a>
							</span> -->
