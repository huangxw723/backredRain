...
<body>
	...
	<form action="shopowner/resetPwd" name="usersForm" id="usersForm" method="post">
	...
	<table id="table_report" class="table table-striped table-bordered table-hover" style="overflow:scroll;">
		...
		<tr height="45px">
			<td>商家帐号:</td>
			<td><input disabled="disabled" type="text" name="account" id="account" value="${pd.account}" placeholder="请输入商家帐号" style="width: 370px" onkeyup="validateUtils.replaceSpaceEmpty(this);"/></td>
		</tr>
