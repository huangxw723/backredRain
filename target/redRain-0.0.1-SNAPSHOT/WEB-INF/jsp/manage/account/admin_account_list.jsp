...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="<%=basePath%>account/getAdminAccountList" method="post" name="usersForm" id="usersForm">
	  ...
	  //更新状态
		...
		function add(otype){
			...
			form.find('#showCount').attr('name','showCount');
			 ...
			 diag.Drag=true;
			 diag.Title ="新增";
			 diag.URL = '<%=basePath%>account/addAdminAccountPage?action='+1+'&type='+otype;
			 diag.Width = 840;
			 diag.Height = 650;
