...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
		<!-- 检索  -->
		<form action="<%=basePath%>account/getExchangeRecordList" method="post" name="usersForm" id="usersForm">
			...
			<table id="table_report" class="table table-striped table-bordered table-hover">
				...
				<thead>
					<tr>
						...
						<th style="text-align:center;">兑换商品</th>
					...
					<c:when test="${not empty list}">
						<c:forEach items="${list}" var="var" varStatus="vs">
							<tr>
								...
								<td class='center' style="text-align:center;">${var.goodsName}</td>
								<td class='center' style="text-align:center;">${var.goodsAmount}</td>
								<td class='center' style="text-align:center;">${var.salesPoint}</td>
								<td class='center' style="text-align:center;">${var.orderPrice}</td>
								<td class='center' style="text-align:center;">
									<a href="javascript:void(0);" onclick="viewOrder('${var.id}','${var.sn}');">${var.sn}</a>
								</td>
								<td class='center' style="text-align:center;">${var.orderTime}</td>
