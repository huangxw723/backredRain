      ...
      <div class="tabbable">
        ...
        <div class="tab-content">
          <div id="shopOwnerInfo" class='tab-pane fade in active'>
            <iframe name="shopOwnerInfoFrame" id="shopOwnerInfoFrame" frameborder="0" src="<%=basePath%>account/ownerInfoPage.do?type=${type}&shopId=${shopId}&action=2" style="margin:0 auto;width:100%;height:100%;"></iframe>
          </div>
          <div id="shopAccountInfo" class='tab-pane fade '>
            <iframe name="shopAccountInfoFrame" id="shopAccountInfoFrame" frameborder="0" src="<%=basePath%>account/shopInfoPage.do?type=${type}&shopId=${shopId}&action=2" style="margin:0 auto;width:100%;height:100%;"></iframe>
          </div>
