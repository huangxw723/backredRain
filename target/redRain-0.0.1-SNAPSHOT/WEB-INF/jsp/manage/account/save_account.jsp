    ...
    <div id="zhongxin">
      <table id="table_report" class="table table-striped table-bordered table-hover">
       <tr>          
          <th>角色:</th>
          <td>
              <select class="chzn-select" data-placeholder="用户角色" name="roleId" id="roleId" title="用户角色" <c:if test="${action == 4}">disabled="disabled"</c:if>>
            <c:forEach items="${roleList}" var="va">
                <option value="${va.roleId}" > ${va.roleName }</option>
