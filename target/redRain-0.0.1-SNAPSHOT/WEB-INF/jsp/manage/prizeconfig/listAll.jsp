  ...
  <div class="row-fluid">
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		function toExcel(){
			...
			window.location.href='<%=basePath%>prizeconfig/bigWheelExcel.do?provinceId='+provinceId+'&cityId='+cityId+'&areaId='+areaId+'&categoryId='+categoryId+'&status='+status+'&isJackpot='+isJackpot+'&keyWord='+keyWord+'&showCount='+showCount+'&currentPage='+currentPage;
		...
		function addPrize(){
					...
					form.find('#showCount').attr('name','showCount');
					 ...
					 diag.Drag=true;
					 diag.Title ="添加礼品";
					 diag.URL = '<%=basePath%>prizeconfig/page?action=1&activityType='+"${activityType}"+"&isJackpot="+"${pd.isJackpot}";
					 diag.Width = 1150;
					 diag.Height = 760;
