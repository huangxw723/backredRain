	...
	<div id="zhongxin" >
      ...
      <%--   
       <tr>
	      <th>城市:</th>
          <td>
            <select class="chzn-select" name="provinceId" id="provinceId" data-placeholder="省份" style="vertical-align:top;" disabled="disabled" >
              <c:forEach items="${provinceList}" var="district">
                <option value="${district.provinceId}" <c:if test="${district.provinceId == obj.provinceId }">selected</c:if>>${district.provinceName}</option>
              </c:forEach>
              </select>
          </td>
        </tr> --%>
        ...
        <tr>
          <th>名称:</th>
          <td>
            <input type="text"  value="${obj.name}"  style="width:90%;" disabled="disabled"/>
          </td>
        </tr>
        ...
        <tr>
          <th>电话:</th>
          <td>
            <input type="text" style="width:90%;"  value="${obj.phone}" disabled="disabled"/>
          </td>
        </tr>
         ...
         <tr>
          <th>品牌:</th>
          <td>
            <select class="chzn-select" name=brandId id="brandId" data-placeholder="品牌" style="vertical-align:top;" disabled="disabled">         
              <c:forEach items="${brandList}" var="district"> 
                <c:if test="${district.isShow=='Y'}">
                <option value="${district.brandId}" <c:if test="${district.brandId == obj.brandId}">selected</c:if>>${district.brandName}</option>
                </c:if>
              </c:forEach>
            </select>
          </td>
        ...
        <tr>
          <th>酒店价格:</th>
          <td>
            <input type="text" style="width:90%;" name="suggestPrice" id="suggestPrice" value="${obj.suggestPrice}" placeholder="请输入酒店价格" title="酒店价格"  disabled="disabled"/>
          </td>
        </tr>
        ...
        <tr>
          <th>酒店星级:</th>
          <td>
            <input type="text" style="width:90%;" name="starLevel" id="starLevel" value="${obj.starLevel}" placeholder="请输入酒店星级" title="酒店星级"  disabled="disabled"/>
          </td>
        </tr>
