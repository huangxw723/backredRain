  ...
  <div id="page-content" class="clearfix">
    ...
    <div class="row-fluid">
      ...
      <div class="row-fluid">
        ...
        <!-- 检索  -->
        <form action="link/beaconGroup/chooseBeacon.do" method="post" name="usersForm" id="usersForm" style="margin: 10px">
          ...
          <table>
            <tr>
              ...
              <td>
                <a class="btn btn-small btn-success" style="line-height: 20px;" id="sear">查询</a>
              </td>
            </tr>
          </table>
        </form>
        <!-- 检索  -->         
          ...
          <tbody>
                ...
                <!-- 开始循环 -->
                <c:choose>
                  <c:when test="${not empty asBeacons}">
                    <c:forEach items="${asBeacons}" var="var" varStatus="vs">
                      <tr>
