...
<body>
	 <div id="page-content" class="clearfix" >
		...
		<div class="row-fluid">
			...
			<form class="form-horizontal" id="form" action="group/saveAdmin.do" method="post">

				<div class="control-group">
					<label class="control-label" >真实姓名</label>
					<div class="controls">
						<input type="text" name="adminName" placeholder="真实姓名" required>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label" >手机号码</label>
					<div class="controls">
						<input type="text" name="adminPhone" placeholder="手机号码" required>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label" >账户名称</label>
					<div class="controls">
						<input id="userName" type="text" name="username" placeholder="账户名称" required>
					</div>
				</div>
				<div class="control-group">
				...
				<div align="center" style="height:40px;">
           			 <a class="btn btn-mini btn-primary" onclick="saveAdmin();">保存</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
