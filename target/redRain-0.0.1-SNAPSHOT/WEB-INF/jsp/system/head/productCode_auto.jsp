...
<body>
	...
	<form action="createCode/proCode_auto.do" name="Form" id="Form" method="post">
		<input type="hidden" name="zindex" id="zindex" value="0">
		<div id="zhongxin">
		<table style="margin-top: 10px;">
		    <tr>
		    	<td style="width:15%;text-align: right;">选择表名：</td>
		    	<td>
		    		<select  name="tablename" id="tablename" data-placeholder="请选择表名" style="vertical-align:top;width: 120px;">
						
						<c:forEach items="${tlist}" var="table">
			 ...
			 <tr>
				...
				<td>&nbsp;&nbsp;例如:com.aoshi.controller.<font color="red" style="font-weight: bold;">system</font>&nbsp;&nbsp;红色部分</td>
			</tr>
			<!--  
			<tr>
		...
		<script src="static/js/myjs/productCode_auto.js"></script>
