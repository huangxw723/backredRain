...
<body>
	<div id="page-content" class="clearfix">
		...
		<div class="row-fluid">
			...
			<form class="form-horizontal" id="form" action="goods/saveGoodsImgs.do" method="post" enctype="multipart/form-data">
				...
				<div class="control-group" >
					<label class="control-label"></label>
					<div class="controls">
						可添加多张图片，一次性最多5张图片     <font color="red">注：(图片尺寸规格750px * 638px)</font>
					</div>
					<div class="controls">
			...
			function selectImg($this){
				...
				if(parseInt(fileSize)>2048){
				 ...
				 var thisvalue = $($this).val();
				  ...
				  var value = 8 - times;
					if(len>value){
						bootbox.alert("最多能添加8张商品图片,您现在只能添加"+value+"张");
						$($this).remove();	
						$($this).val("");
						$("#imgClean").show();
						return ;
