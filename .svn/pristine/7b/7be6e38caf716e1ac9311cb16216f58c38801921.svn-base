...
<body>  
    <form class="form-horizontal" id="form" name="form" action="consultationInfo/saveEdit.do" method="post">
    <input type="hidden" name="consultationInfoId" id="consultationInfoId" value="${obj.consultationInfoId}" />
