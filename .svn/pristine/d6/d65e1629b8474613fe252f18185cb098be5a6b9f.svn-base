...
public class RoleService {
	...
	@SuppressWarnings("unchecked")
	public List<Role> getRolesByUser(String userId) throws Exception {
		return (List<Role>) dao.findForList("RoleMapper.getRolesByUser", userId);
	}

	@SuppressWarnings("unchecked")
	public List<Role> listAllRolesByUser(String userId) throws Exception {
		return (List<Role>) dao.findForList("RoleMapper.listAllRolesByUser", userId);
	}
	...
	public Role findByRoleName(String roleName){
		return (Role) dao.findForObject("RoleMapper.findByRoleName", roleName);
	}
