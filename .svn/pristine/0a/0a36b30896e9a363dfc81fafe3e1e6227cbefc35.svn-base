...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 查询  -->
			<form action="prizeconfig/listAuditHistory.do" method="post" name="usersForm" id="usersForm">
						...
						<c:forEach items="${list}" var="var" varStatus="vs">
							...
							<tr>
								...
								<input type="hidden" name="prizeConfigById" id="prizeConfigById" value=""/>
									...
									<a class="" onclick="sendHistory(${var.prizeConfigId})">详情</a>
								</td>	
								</form>
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		//历史页面跳转
		function sendHistory(prizeConfigId){
			var prizeConfigById = prizeConfigId;
			$("#prizeConfigById").val(prizeConfigById);
