    ...
    <div id="zhongxin">
      <table id="table_report" class="table table-striped table-bordered table-hover">
        <tr>
          <th>终端标识:</th>
          <td>
           <input placeholder="终端标识" <c:if test="${pd.action==2}">disabled="disabled"</c:if>  type="text" style="width:89%;" name="sn" id="sn" value="${sc.sn }" title="终端标识" />
          </td>
        </tr>
        ...
        <tr>
          <th>绑定域名:</th>
          <td style="size: 67px;">
            <select data-placeholder="绑定域名" class="chzn-select"   name="screenDomainId" id="screenDomainId" data-placeholder="绑定域名" style="width: 80%;">
             <option value=""></option> 
        ...
        <tr>
					...
					<td><select 
						...
						data-placeholder="请选择省份" style="vertical-align: top; width: 26%">
							<option value=""></option>
					...
					</select> <select class="chzn-select" name="areaId" id="areaId" data-placeholder="请选择区域"
						style="vertical-align: top; width: 27%"
						<c:if test="${pd.action==2}">disabled="disabled"</c:if>>
						<c:if test="${pd.action==2}">
						   <option value=""></option>
        ...
        <th>详细地址:</th>
         <td>
            <input placeholder="详细地址" type="text" style="width:89%;" name="address" id="address" value="${sc.address }" title="详细地址" />
