		...
		<div id="sidebar" class="menu-min">
				...
				<div id="sidebar-shortcuts">
					...
					<div id="sidebar-shortcuts-large">
						...
						<button style="width: 40%;" class="btn btn-small btn-success" onclick="changeMenu();" title="切换"><i class="icon-pencil"></i></button>
						...
						<button style="width: 40%;" class="btn btn-small btn-danger" title="菜单管理" id="adminmenu" onclick="menu();"><i class="icon-folder-open"></i></button>
