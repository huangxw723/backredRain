...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="<%=basePath%>account/getShopAccountList" method="post" name="usersForm" id="usersForm">
	       ...
	       创建时间:<span>
            ...
            <span>
			 ...
			 <%-- <a class="btn btn-small btn-success" style="vertical-align:top;" onclick="add();">新增</a>--%>
				<a class="btn btn-small btn-success" style="vertical-align:top;" onclick="saveAccount();">新增</a>
          </span>
...
// 			form.find('#showCount').attr('name','showCount');
		...
		function saveAccount(){
			...
			diag.Drag=true;
			diag.Title ="新增商户";
			diag.URL = '<%=basePath%>account/saveAccountPage.do';
			diag.Width = 580;
			diag.Height = 400;
			diag.CancelEvent = function () { //关闭事件
				diag.close();
		...
		/*function edit(id){
			...
			form.find('#showCount').attr('name','showCount');
			 ...
			 diag.Drag=true;
			 diag.Title ="编辑";
			 diag.URL = '<%=basePath%>account/addShopAccountInfoPage?action='+2+'&shopId='+id;
			 diag.Width = 1080;
			 diag.Height = 920;
			 diag.CancelEvent = function () { //关闭事件
