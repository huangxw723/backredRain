		...
		<div class="row-fluid">
			...
			<form class="form-horizontal" id="form" action="coupon/editCoupon.do" method="post" enctype="multipart/form-data">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input id="name" type="text" name="name" value="${coupon.name}" placeholder="优惠券名称" required />
					</div>
				</div>
					...
					<div class="controls">
						<select name="prizeTypeId">
							<c:forEach items="${prizeTypes}" var="t">
								<option ${coupon.prizeTypeId==t.prizeTypeId?'selected':''} value="${t.prizeTypeId}">${t.prizeTypeName}</option>
							</c:forEach>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input name="color" class="jscolor" value="${coupon.color }" />
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						<c:forEach items="${tags}" var="tag">
							<label>
								<input ${tag.checked?'checked':'' }  class="tagId" type="checkbox" value="${tag.tagId }"/>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type='text' value="${coupon.startTime }" name="startTime" class="date-picker" data-date-format="yyyy-mm-dd" readonly="readonly">
					</div>
				</div>
				<div class="control-group">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input id="" type='number' value="${coupon.price }" name="price">
					</div>
				</div>
				<div class="control-group">
