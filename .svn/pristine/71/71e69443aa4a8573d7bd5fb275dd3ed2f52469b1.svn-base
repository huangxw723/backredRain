...
function() {
	...
	e = function() {
		...
		e.prototype.set_default_text = function() {
			...
			this.results_none_found = this.form_field.getAttribute("data-no_results_text") || this.options.no_results_text || "找不到"
		},
...
function() {
	...
	t = function(t) {
		...
		s.prototype.result_select = function(e) {
			...
			r.selected = !0,
			this.form_field.options[r.options_index]==undefined?false:this.form_field.options[r.options_index].selected = !0,
			...
			(this.is_multiple || this.form_field_jq.val() !== this.current_value) && this.form_field_jq.trigger("change", {
				selected: this.form_field.options[r.options_index]==undefined?false:this.form_field.options[r.options_index].value
			}),
			this.current_value = this.form_field_jq.val(),
			this.search_field_scale()
		},
