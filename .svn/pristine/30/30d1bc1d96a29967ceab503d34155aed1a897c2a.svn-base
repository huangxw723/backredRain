...
<input type="hidden" value="${shopOwnerId}">
        ...
        <ul class="nav nav-tabs" id="myTab">
          ...
          <li>
            <a data-toggle="tab" data-target="#store" href="javascrpipt:void(0);">
              <i class="red icon-list-alt bigger-150"></i> 商户/商场信息
            </a>
          </li>
        </ul>
        <div class="tab-content">
          <div id="district" class="tab-pane fade in active">
            <iframe name="districtFrame" id="districtFrame" frameborder="0" src="<%=basePath%>shopowner/shopInfo.do?action=${action}&shopOwnerId=${shopOwnerId}" style="margin:0 auto;width:100%;height:100%;"></iframe>
          </div>
          <div id="store" class="tab-pane fade">
            <iframe name="storeFrame" id="storeFrame" frameborder="0" src="<%=basePath%>shopowner/shopOwnerInfo.do?action=${action}&shopId=${shopId}&shopOwnerId=${shopOwnerId}&status=${status}" style="margin:0 auto;width:100%;height:100%;"></iframe>
          </div>
        </div>
      </div>
