...
public class MenuService {
	...
	@SuppressWarnings("unchecked")
	public List<Menu> listSubMenuByType(PageData pd) throws Exception {
		return (List<Menu>) dao.findForList("MenuMapper.listSubMenuByType", pd);
	}

	@SuppressWarnings("unchecked")
	public List<Menu> listMenuByType(PageData pd) throws Exception {
		return (List<Menu>) dao.findForList("MenuMapper.listMenuByType", pd);
	}
