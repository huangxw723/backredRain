...
//    }
    ...
    public void sendSms1(String mobile, String code) {
...
//        }
        String PostData = "";
        try {
            PostData = "account=" + smsConfig.getUsername() + "&password=" + smsConfig.getPassword() + "&mobile=" + mobile + "&content=" + URLEncoder.encode(code, "utf-8");
     ...
     *            短信内容
     */
    public  void sendSms2(String mobile, String content) {
        ...
        try {
            ...
            NameValuePair[] data = {// 提交短信
                    new NameValuePair("account", props.getProperty("sms.username")), new NameValuePair("password", props.getProperty("sms.password")), // 密码可以使用明文密码或使用32位MD5加密
    ...
    private static String smsUrl = "http://114.113.154.5/sms.aspx?action=send";
	 /**
    * 给一个人发送单条短信
    *
    * @param mobile
   ...
   public void sendSms(String mobile, String content) {
       ...
       NameValuePair[] data = {// 提交短信
               new NameValuePair("account", smsConfig.getUsername()), new NameValuePair("password", smsConfig.getPassword()), // 密码可以使用明文密码或使用32位MD5加密
               new NameValuePair("mobile", mobile), new NameValuePair("content", content), };
