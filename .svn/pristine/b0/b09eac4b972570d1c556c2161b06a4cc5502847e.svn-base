...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
		...
		<form action="<%=basePath%>yp/admin/message/getAllMessageList" method="post" name="usersForm" id="usersForm" style="display:none;">
...
<!--/#page-content-->
        ...
        function add(){
            ...
            diag.Drag=true;
            diag.Title ="添加背景图";
            diag.URL = '<%=basePath%>yp/admin/message/addMessagePage.do';
            diag.Width = 1024;
            diag.Height =1050;
