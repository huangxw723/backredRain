...
<body >
	...
	<div id="zhongxin" >
        ...
        <tr>
	      <th>资讯类型:</th>
           <td>
             <select class="chzn-select" style="vertical-align:top;" disabled="disabled">                                      	
             	<option value="38">便民</option>
            </select>
            <select class="chzn-select" name="typeId" id="typeId" data-placeholder="请选择二级分类" style="vertical-align:top;" disabled="disabled">
              <option value=""></option>      
      ...
      <%--   <tr>
        ...
        <tr>
         ...
         <tr>
          ...
          <tr>
          <th>开放时间:</th>
          <td><input type="text" value="${obj.openTime}" style="width:100%" disabled="disabled"></td>
        </tr>
         ...
         <tr>
			  ...
			  <tr>
				<td>线路图:</td>
				<td>				
						<a id="imgBox" class="has" href="<%=httpUrl%>${obj.lineImg}" title="${obj.lineImg}">
							<img src="<%=httpUrl%>${obj.lineImg}" alt="${obj.lineImg}" width="750" height="666"/>
						</a>
				</td>
			</tr>
		  ...
		  <tr>
				<th>正文内容:</th>
					<td><textarea name="content" id="content" disabled="disabled" >${obj.content}</textarea>
					</td>
				</tr> 
