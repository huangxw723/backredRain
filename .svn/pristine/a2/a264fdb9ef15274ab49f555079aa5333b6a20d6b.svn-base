...
<body >
	...
	<div id="zhongxin" >
        ...
        <tr>
	      <th>地址:</th>
          <td><input type="text" value="${cate.province.provinceName }&nbsp${cate.city.cityName}&nbsp${cate.area.areaName}&nbsp${cate.businessDistrict.name}" style="width:100% " disabled="disabled"><td>
        </tr>
        ...
        <tr>
          <th>品类:</th>
          <td><input type="text" value="${cate.asYpBaseCategory.name }" style="width:100% " disabled="disabled"></td>
        </tr>
        <tr>
          <th>推荐星级:</th>
          <td><input type="text" value="${cate.recommendLevel}" style="width:100% " disabled="disabled"></td>
        </tr>
		
		<tr>
          <th>推荐理由:</th>
          <td><textarea   disabled="disabled" style="width: 100%;height: 80px" >${cate.recommendResult}</textarea></td>
        </tr>
        ...
        <tr>
         ...
         <tr>
          <th>简介:</th>
          <td><textarea  disabled="disabled" style="width: 100%;height: 150px">${cate.shoppingDesc}</textarea></td>
        </tr>
