...
<form action="consultation/streetFood/save.do" name="usersForm" id="usersForm" method="post">
	<input type="hidden" name="shopId" id="consultationShopId" value="${asConsultationShopId}">
	<div id="zhongxin" >
		<table id="table_report" class="table table-striped table-bordered table-hover" style="overflow:scroll;">
			...
			<tr height="45px">
				<td>描述:</td>
				<td>
					<textarea type="" style="width:650px;height:259px;" name="foodContent" id="foodContent" value="${asConsultationStreetFood.foodContent}"></textarea>
				</td>
			</tr>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		document.getElementById("editor").value=document.getElementById("foodContent").value;
